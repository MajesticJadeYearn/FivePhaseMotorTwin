...
namespace FivePhaseMotorTwin
{
    ...
    public sealed class ScenarioInfo
    {
        ...
        {
            new ScenarioInfo(ScenarioMode.Normal, "正常运行", FaultKind.None, false, "无故障", "健康矢量控制 / SVPWM"),
            new ScenarioInfo(ScenarioMode.WindingOpen, "A 相绕组开路故障", FaultKind.WindingOpen, false, "A 相绕组开路", "ELM已定位绕组开路，等待容错控制投入"),
            new ScenarioInfo(ScenarioMode.UpperSwitchOpen, "A 相上功率管开路故障", FaultKind.UpperSwitchOpen, false, "A 相上功率管开路", "ELM已定位功率管开路，等待半波畸变补偿"),
            new ScenarioInfo(ScenarioMode.LowerSwitchOpen, "A 相下功率管开路故障", FaultKind.LowerSwitchOpen, false, "A 相下功率管开路", "ELM已定位功率管开路，等待半波畸变补偿"),
            new ScenarioInfo(ScenarioMode.WindingOpenTolerance, "A 相绕组开路 + 容错控制", FaultKind.WindingOpen, true, "A 相绕组开路", "ELM联动绕组开路容错控制"),
            new ScenarioInfo(ScenarioMode.UpperSwitchOpenTolerance, "A 相上功率管开路 + 容错控制", FaultKind.UpperSwitchOpen, true, "A 相上功率管开路", "ELM联动上桥臂开路容错控制"),
            new ScenarioInfo(ScenarioMode.LowerSwitchOpenTolerance, "A 相下功率管开路 + 容错控制", FaultKind.LowerSwitchOpen, true, "A 相下功率管开路", "ELM联动下桥臂开路容错控制")
        };
